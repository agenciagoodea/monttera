...
conn.on('ready', () => {
  console.log('SSH conectado. Listando arquivos em dist/...\n');

  const commands = [
    'ls -la /home/digitalbordados/digitalbordados/dist/',
    'ls -la /home/digitalbordados/digitalbordados/dist/assets/'
  ];

...
if (normalizedContent.includes(normalizedTarget)) {
  ...
  const part1 = content.slice(0, index); // aproximado
  // Vamos fazer a substituição direta na string com regex ou replace literal
  content = normalizedContent.replace(normalizedTarget, replacementStr);
  fs.writeFileSync(targetFilePath, content, 'utf8');
  console.log('ProductDetail.tsx atualizado com sucesso via script!');
} else {

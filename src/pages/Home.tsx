        ...
        <div className="flex-1">
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Custom Request Box */}
              <div className="mt-12 bg-white border border-slate-100 rounded-[2.5rem] p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
                <div className="flex flex-col text-center md:text-left">
                  <h3 className="text-lg font-black text-slate-800 uppercase tracking-tight">Não achou a sua matriz?</h3>
                  <p className="text-sm text-slate-500 font-bold">Nós podemos criar uma matriz personalizada para você!</p>
                </div>
                <button className="bg-primary text-white px-10 py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center gap-3 shadow-lg shadow-blue-600/20 hover:bg-blue-700 transition-all">

                    ...
                    <tr key={category.id} className={`transition-colors group ${category.level > 0 ? 'bg-blue-50/35 hover:bg-blue-50/55' : 'bg-white hover:bg-slate-50/50'}`}>
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${category.level > 0 ? 'bg-blue-100 text-blue-600' : 'bg-slate-100 text-slate-400'}`}>
                            {category.icon ? (
            ...
            <form onSubmit={handleSubmit} className="p-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div className="w-14 h-14 bg-slate-50 border border-slate-200 rounded-2xl flex items-center justify-center text-slate-700">
                    {formData.icon ? (
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-5 rounded-3xl font-black text-xs uppercase tracking-[0.2em] shadow-2xl shadow-blue-500/20 hover:bg-blue-700 hover:-translate-y-1 active:translate-y-0 transition-all flex items-center justify-center gap-3"
                >

...
conn.on('ready', () => {
  console.log('SSH conectado. Lendo as últimas 100 linhas do log do PM2...\n');

  conn.exec(`tail -n 100 /home/digitalbordados/.pm2/logs/digitalbordados-out.log`, (err, stream) => {
